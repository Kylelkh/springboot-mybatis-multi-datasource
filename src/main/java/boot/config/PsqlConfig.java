...
public class PsqlConfig {
        ...
        public DataSource getPslDataSource(){
            return DataSourceBuilder.create().build();
        }

        @Bean("psqlSqlSessionFactory")
        public SqlSessionFactory psqlSqlSessionFactory(@Qualifier("psql") DataSource dataSource) throws Exception {
            ...
            final Resource[] resources = new PathMatchingResourcePatternResolver().getResources("classpath:/mapper/PsqlUserMapper.xml");
        ...
        public SqlSessionTemplate psqlSqlSessionTemplate(@Qualifier("psqlSqlSessionFactory") SqlSessionFactory sqlSessionFactory){
            return new SqlSessionTemplate(sqlSessionFactory);
        }

        @Bean("psqlSqlSessionTemplateForBatch")
        public SqlSessionTemplate psqlSqlSessionTemplateForBatch(@Qualifier("psqlSqlSessionFactory") SqlSessionFactory sqlSessionFactory){
